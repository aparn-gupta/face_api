...
//             const referenceImg = await faceapi.fetchImage(each)
        
//             const refernceImgAIData = await faceapi
...
//             const faceMatcher = new faceapi.FaceMatcher(refernceImgAIData)
...
//                 const label = item.findBestMatch(descriptor).toString()
//                 const options = label.includes("unknown") 
